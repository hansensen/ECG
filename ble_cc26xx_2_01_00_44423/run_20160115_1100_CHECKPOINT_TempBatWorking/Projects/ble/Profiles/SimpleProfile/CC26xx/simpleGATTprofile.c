...
static uint8 simpleProfileChar1UserDesp[14] = "Configuration\0";
...
static uint8 simpleProfileChar2 = 10;

static gattCharCfg_t *simpleProfileChar2Config;

// Simple Profile Characteristic 2 User Description
static uint8 simpleProfileChar2UserDesp[20] = "Alert Notification\0";
...
static uint8 simpleProfileChar3UserDesp[27] = "ECG RESP ACC Data Selector\0";
...
static uint8 simpleProfileChar4[SIMPLEPROFILE_CHAR4_LEN] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14};
...
static uint8 simpleProfileChar4UserDesp[24] = "Activate Profile Char 4\0";
...
static uint8 simpleProfileChar5[SIMPLEPROFILE_CHAR5_LEN] = { 0x00, 0x00 };

static gattCharCfg_t *simpleProfileChar5Config;

// Simple Profile Characteristic 5 User Description
static uint8 simpleProfileChar5UserDesp[13] = "Battery Life\0";
...
static uint8 simpleProfileChar6[SIMPLEPROFILE_CHAR6_LEN] = { 0x50, 0x05 };

static gattCharCfg_t *simpleProfileChar6Config;

// Simple Profile Characteristic 6 User Description
static uint8 simpleProfileChar6UserDesp[17] = "Body Temperature\0";


// Simple Profile Characteristic 9 Properties
static uint8 simpleProfileChar9Props = GATT_PROP_NOTIFY | GATT_PROP_WRITE | GATT_PROP_READ;

// Characteristic 9 Value
static uint8 simpleProfileChar9[SIMPLEPROFILE_CHAR9_LEN] = { 0xBB, 0x04, 0xB3, 0x04, 0xAD, 0x04, 0xA7, 0x04, 0xA1, 0x04, 0x23, 0x00};
...
static uint8 simpleProfileChar9UserDesp[12] = "5CalADCTemp\0";
...
bStatus_t SimpleProfile_AddService( uint32 services )
{
  ...
  simpleProfileChar9Config = (gattCharCfg_t *)ICall_malloc( sizeof(gattCharCfg_t) * linkDBNumConns );
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR9_UUID:
        ...
        if ( status == SUCCESS )
        {
          ...
          if( pAttr->pValue == simpleProfileChar9 )
          {
